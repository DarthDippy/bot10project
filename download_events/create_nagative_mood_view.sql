-- View: decode.negative_mood_events

-- DROP VIEW decode.negative_mood_events;

CREATE OR REPLACE VIEW decode.negative_mood_events AS 
 SELECT events_with_keyword_counts.event_id,
  ...
  ORDER BY events_with_keyword_counts.negative_keyword_count DESC
 LIMIT 10;

ALTER TABLE decode.negative_mood_events
  OWNER TO group10;
